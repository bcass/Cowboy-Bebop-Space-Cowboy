...
sh_int   gsn_charm;
sh_int   gsn_lobby;
sh_int	 gsn_negotiate;
sh_int   gsn_plead;
sh_int   gsn_empathize;

/* Medics */
sh_int   gsn_master_medic;
sh_int   gsn_attend;
sh_int   gsn_bandage;
sh_int	 gsn_heal;
sh_int   gsn_field_research;
sh_int	 gsn_self_medicate;
sh_int	 gsn_surgery;
sh_int	 gsn_treat;
sh_int	 gsn_resuscitate;
sh_int	 gsn_group_heal;
sh_int	 gsn_recover;

/* hackers */
//sh_int	 gsn_hack_systems;
sh_int	 gsn_hackbaydoor;
sh_int   gsn_hackwho;
sh_int   gsn_hackbanktransfer;
sh_int   gsn_hackshipdoor;
sh_int   gsn_hacklaunch;
sh_int   gsn_hackbroadcast;
sh_int   gsn_hackbounty;
sh_int   gsn_hackbank;
sh_int   gsn_hackclanaccount;
sh_int	 gsn_hackcamera;
...
sh_int   gsn_makesword;
sh_int   gsn_spice_refining;
sh_int   gsn_makebloodyeye;
sh_int   gsn_makeyelloweye;
sh_int   gsn_makepurpleeye;
sh_int   gsn_makeblueeye;
sh_int   gsn_makegreeneye;
sh_int   gsn_chemistry;
sh_int   gsn_makeapplicator;
sh_int   gsn_makerawdrug;
sh_int   gsn_makeknife;
sh_int   gsn_makegun;
sh_int   gsn_makerifle;
...
sh_int   gsn_makelaptop;

/* weaponry */
sh_int			gsn_rifles;
sh_int                  gsn_pistols;
sh_int                  gsn_heavy_weapons;
sh_int			gsn_swords;
sh_int			gsn_knives;
...
void boot_db( bool fCopyover )
{
     ...
     */
    {
	long long int lhour, lday, lmonth;
 ...
 //   ASSIGN_GSN( gsn_bribe , "bribe" );
    ...
    ASSIGN_GSN( gsn_plead, "plead");
    ASSIGN_GSN( gsn_lobby, "lobby");
    ASSIGN_GSN( gsn_negotiate, "negotiate");
    ASSIGN_GSN( gsn_discount, "discount");
    ASSIGN_GSN( gsn_appeal, "appeal");
    ASSIGN_GSN( gsn_deceive, "deceive");
    ASSIGN_GSN( gsn_rumors, "spread rumors");
    ASSIGN_GSN( gsn_support, "support");
    ASSIGN_GSN( gsn_empathize, "empathize");
    ASSIGN_GSN( gsn_beg  , "beg" );
    ASSIGN_GSN( gsn_hijack  , "hijack" );
    ASSIGN_GSN( gsn_field_research, "field research");
    ASSIGN_GSN( gsn_surgery, "surgery");
    ASSIGN_GSN( gsn_resuscitate, "resuscitate");
    ASSIGN_GSN( gsn_group_heal, "group_heal");
    ASSIGN_GSN( gsn_recover, "recover");
    ASSIGN_GSN( gsn_treat, "treat");
    ASSIGN_GSN( gsn_self_medicate, "self medicate");
    ASSIGN_GSN( gsn_heal, "heal");
    ASSIGN_GSN( gsn_bandage , "bandage" );
    ASSIGN_GSN( gsn_master_medic, "master medic");
    ASSIGN_GSN( gsn_attend, "attend");
//    ASSIGN_GSN( gsn_hack_systems  , "hacksystems" );
    ASSIGN_GSN( gsn_hackclanaccount, "hackclanaccount");
    ASSIGN_GSN( gsn_hackbank, "hackbank");
    ASSIGN_GSN( gsn_hackcamera, "hackcamera");
    ASSIGN_GSN( gsn_hackbaydoor  , "hackbaydoor" );
    ASSIGN_GSN( gsn_hackwho, "hackwho");
    ASSIGN_GSN( gsn_hackbanktransfer, "hacktransfer");
    ASSIGN_GSN( gsn_hackshipdoor, "hackshipdoor");
    ASSIGN_GSN( gsn_hacklaunch, "hacklaunch");
    ASSIGN_GSN( gsn_hackbroadcast, "hackbroadcast");
    ASSIGN_GSN( gsn_hackbounty, "hackbounty");
    ASSIGN_GSN( gsn_makejewelry  , "makejewelry" );
    ASSIGN_GSN( gsn_grenades  , "grenades" );
    ASSIGN_GSN( gsn_makeknife  , "makeknife" );
    ASSIGN_GSN( gsn_makegun  , "makegun" );
    ASSIGN_GSN( gsn_makerifle , "makerifle");
    ASSIGN_GSN( gsn_makelight   , "makeflashlight" );
    ASSIGN_GSN( gsn_makecomlink   , "makecomlink" );
    ASSIGN_GSN( gsn_makebloodyeye , "makebloodyeye" );
    ASSIGN_GSN( gsn_makeyelloweye , "makeyelloweye" );
    ASSIGN_GSN( gsn_makepurpleeye , "makepurpleeye" );
    ASSIGN_GSN( gsn_makeblueeye , "makeblueeye" );
    ASSIGN_GSN( gsn_makegreeneye , "makegreeneye" );
    ASSIGN_GSN( gsn_chemistry , "chemistry" );
    ASSIGN_GSN( gsn_makelaptop, "makelaptop");
    ASSIGN_GSN( gsn_makeapplicator , "makeapplicator" );
    ASSIGN_GSN( gsn_makerawdrug, "makerawdrug" );
	...
	ASSIGN_GSN( gsn_rifles,	"rifles" );
	ASSIGN_GSN( gsn_pistols,	"pistols" );
	ASSIGN_GSN( gsn_heavy_weapons,	"heavy weapons" );
...
//	ASSIGN_GSN( gsn_berserk,	"berserk" );
	...
	ASSIGN_GSN( gsn_quickdraw,		"quickdraw" );
    ...
    */
	...
	load_slays( );
	log_string( "Loading restore table" );
	load_restores( );
	...
	if (fCopyover)
	{
		log_string("Running: copyover recover.");
		copyover_recover();
	}
...
OBJ_DATA *create_object( OBJ_INDEX_DATA *pObjIndex, int level )
{
	...
	case ITEM_SHIPCOMPONENT:
    case ITEM_GOVERNMENT:
    case ITEM_SPACECRAFT:
    case ITEM_RAWSPICE:
    case ITEM_APPLICATOR:
    case ITEM_MONITOR:
    case ITEM_CASE:
    case ITEM_MOTHERBOARD:
    case ITEM_HARDDRIVE:
    case ITEM_COMPUTER:
    case ITEM_LENS:
    case ITEM_CRYSTAL:
 ...
 */
long long int fread_long( FILE *fp )
{
    ...
    do
    {
        if ( feof(fp) )
        {
          bug("fread_long: EOF encountered on read.\n\r");
          if ( fBootDb )
            exit(1);
          return 0;
        }
...
// We don't need to have a special log for this
    fclose( fpLOG );
...
void make_wizlist( )
{
  ...
  buf[0] = '\0';
  unlink( WIZLIST_FILE );
  towizfile( " Immortals of Space Cowboy" );
  ilevel = 65535;
  for ( wiz = first_wiz; wiz; wiz = wiz->next )
  {
   if ( wiz->level > LEVEL_AVATAR )
   {
	...
	buf[0] = '\0';
      ...
      switch(ilevel)
      {
	case MAX_LEVEL -  0: towizfile( "&C Project Lead&W" );	break;
	case MAX_LEVEL -  1: towizfile( "&R Lead Programmer&W" );	break;
	case MAX_LEVEL -  2: towizfile( "&p Programmers&W" );	break;
	case MAX_LEVEL -  3: towizfile( "&Y Lead Builder&W" ); break;
	case MAX_LEVEL -  4: towizfile( "&c Lead Roleplay&W" );	break;
	case MAX_LEVEL -  5: towizfile( "&B Building Specialist&W" );	break;
	case MAX_LEVEL -  6: towizfile( "&p Senior Builders&W" );	break;
	case MAX_LEVEL -  7: towizfile( "&g Advanced Builders&W" );	break;
	case MAX_LEVEL -  8: towizfile( "&r Junior Builders&W" );	break;
	case MAX_LEVEL -  9: towizfile( "&P Player Testers&W" );	break;
	case MAX_LEVEL -  10: towizfile( "&R Advanced RP&W" );	break;
	case MAX_LEVEL -  11: towizfile( "&C RP Assistants&W" );	break;
	case MAX_LEVEL -  12: towizfile( "&G Trainees&W" );	break;
	case MAX_LEVEL -  13: towizfile( "&B Janitors&W" );	break;
	default:             towizfile( " &z Retired&W" );	break;
      }
    }
...
void fread_sysdata( SYSTEM_DATA *sys, FILE *fp )
{
	...
	case 'B':
	    ...
	    KEY( "Big_Shot",	   sys->big_shot,	  fread_number( fp ) );
	    break;
...
// Fixed to counter-act color shit - Gatz
// Used to center text with white spaces
/*
char *centertext(char *text, int size)
{
  ...
  x = strlen(text);
  y = strlen(remand(text));
  if( x != y)
  {
  	x -= y;
	for(turn = 0; turn < x/2; turn++)
	{
		strcat(buf," ");
		strcat(buf," ");
	}
...
*/
 ...
 /*
  * This is basicly a slightly mod'ed version of capitalize
  * which basicly lets groups of words or phrase capitalize correctly:
  * EG: "bob jones" would be "Bob Jones" as oppesed to capitalize's "Bob jones"
  * - Gatz
  */
char *supercapitalize( const char *str )
{
    static char strcap[MAX_STRING_LENGTH];
    int i, l;
    ...
    for ( i = 0; str[i] != '\0'; i++ )
    {
        strcap[i] = LOWER(str[i]);
	l = i - 1;
	if(str[l] == ' ' && str[i] != '\0' && i > 1)
		strcap[i] = UPPER(str[i]);
        if(str[l] == '_' && str[i] != '\0' && i > 1)
                strcap[i] = UPPER(str[i]);
