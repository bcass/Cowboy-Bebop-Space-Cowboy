...
char *	const	hair_list	[] =
{
	...
	"Jet Black","Midnite Black","Charcoal","Expresso",
	"Chocolate","Walnut Brown",
	"Pecan Brown","Blonde", "Irish Red",
	"Auburn","Paprika","Mahogany","Flame Grey","Pewter","Silver", "Snowflake",
...
char *	const	eye_list	[] =
{
	...
	"Baby Blue","Evergreen","Jade Green","Muddy Brown",
	"Sable Brown","Midnite","Black","Purple","Blood Red",
	"Charcoal Grey","SkyBlue","Lavender"
};
...
"leadership", "hacking", "chemist", "medic"
};
...
const	struct	str_app_type	str_app		[26]		=
{
    ...
    {  2,  4, 250, 25 }, /* 18  */
    {  3,  5, 400, 30 },
    {  3,  6, 500, 35 }, /* 20   hit dam carry wield */
    {  4,  7, 600, 40 },
    {  5,  7, 700, 45 },
    {  6,  8, 800, 50 },
    {  8, 10, 900, 55 },
